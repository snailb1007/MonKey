...
- [ ] **Phase 1: Workspace Architecture, Transport Foundation & Device Probing** - Establish modular Rust workspace, safe dual-interface HID transport (Interface A `0xFF68` / Interface B `0xFFFF`), MockTransport, and read-only device probing.
...
- [ ] **Phase 3: High-Performance LCD Rendering & Streaming Engine** - Ingest and dither images to 128x128 RGB565, slice into 8x 4096B chunks, and stream static images and 10–15 FPS animations over Interface A.
